        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-8">
          {teachers.map((t) => (
            <a
              ...
              className="group block bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-gray-100 hover:shadow-md hover:border-[var(--color-gold-light)] transition-all"
            >
